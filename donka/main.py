...
class MainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.n_tips.setValidator(OptionalIntValidator(1, 3, self))
        self.throw_power.setValidator(OptionalIntValidator(1, 100, self))
        self.min_dx.setValidator(OptionalIntValidator(30, 150, self))
